        ...
        <div
            ...
            <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                ...
                <form class="space-y-4 md:space-y-6" action="/login" method="post">
                    ...
                    <button type="submit"
                        class="w-full text-white bg-primary-950 hover:bg-primary-350 focus:ring-4 focus:outline-none focus:ring-primary-250 font-medium rounded-lg text-sm px-5 py-2.5 text-center">Login</button>
