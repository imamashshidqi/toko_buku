                ...
                <div class="grid gap-4 mb-4 sm:grid-cols-2">
                    ...
                    <div>
                        <label for="rating"
                            ...
                            (1-5)</label>
                        <input type="text" name="rating" id="rating" value="{{ old('rating', $book->rating) }}"
                    ...
                    <div>
                        ...
                        <select name="id_kategori" id="id_kategori"
                            ...
                            @foreach ($categories as $category)
                                <option value="{{ $category->id }}" @selected(old('id_kategori', $book->id_kategori) == $category->id)>
                                    {{ $category->name }}
                                </option>
                            @endforeach
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <textarea name="deskripsi" id="deskripsi" rows="4"
                            ...
                            placeholder="Write book description here">{{ old('deskripsi', $book->deskripsi) }}</textarea>
                    </div>
                </div>
