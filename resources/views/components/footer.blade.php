<footer
    ...
    <p class="mb-4 text-sm text-center text-gray-500 dark:text-gray-400 sm:mb-0">
        &copy; 2025 <a href="#" class="hover:underline" target="_blank">Bookie.com</a> Build with
        ❤️ by <a href="instagram.com/imam_ashshidqi" class="hover:underline" target="_blank">Kelompok Pemesanan Buku</a>.
        All
        rights reserved.
    </p>
