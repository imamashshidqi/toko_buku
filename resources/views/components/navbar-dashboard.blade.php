<nav class="bg-primary-700 fixed left-0 right-0 top-0 z-50" x-data="{ isOpen: false }">
        ...
        <div class="flex h-16 items-center justify-between">
            ...
            <div class="hidden md:block">
                <div class="ml-4 flex items-center md:ml-6">
                    ...
                    @auth
                        <button type="button"
                            class="relative rounded-full bg-primary-600 p-1 text-primary-400 hover:text-white focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-primary-800 focus:outline-hidden">
                        ...
                        <div class="relative ml-3">
                            <div>
                                <button type="button" @click="isOpen = !isOpen"
                                    class="relative flex max-w-xs items-center rounded-full bg-primary-800 text-sm focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-primary-800 focus:outline-hidden"
